...
from model import *
import copy
#from model import QuantizedSeeInDark
    ...
    for epoch in range(lastepoch,20000):
        ...
        for ind in np.random.permutation(len(train_ids)):
            ...
            if epoch%save_freq==0:
                ...
                jit_name = './' + str(epoch) + '_' + 'light_quantized_model.jit'
...
#init
input_dir = '/home/ubuntu/data/Sony/short/'
gt_dir = '/home/ubuntu/data/Sony/long/'
...
model.train()
model.to(device)
quantized_model = Quantized_Light_SeeInDark(model_fp32=model)
